      ...
      <div className='w-full min-h-screen bg-white dark:bg-[#0b1220] pt-24 pb-20 overflow-x-hidden relative'>
        <div ref={sectionRef} className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10">
          ...
          <div className="contact-title text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-black dark:text-white mb-4">Customer Support Center</h1>
            <p className="text-lg text-gray-700 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-[#1f2a44]">
              ...
              <div className="p-6 hover:bg-gray-100 dark:hover:bg-[#111c33] transition-colors duration-200">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-400 uppercase tracking-wider mb-2">Phone</h3>
                  <p className="text-black dark:text-white font-medium mb-1">+91-9307342318</p>
                  <p className="text-gray-600 dark:text-gray-500 text-sm">Mon-Fri 9AM-6PM</p>
                </div>
              </div>
              ...
              <div className="p-6 hover:bg-gray-100 dark:hover:bg-[#111c33] transition-colors duration-200">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-400 uppercase tracking-wider mb-2">Email</h3>
                  <p className="text-black dark:text-white font-medium mb-1">admin@riveto.com</p>
                  <p className="text-gray-600 dark:text-gray-500 text-sm">24/7 Support</p>
                </div>
              </div>
              ...
              <div className="p-6 hover:bg-gray-100 dark:hover:bg-[#111c33] transition-colors duration-200">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-400 uppercase tracking-wider mb-2">Visit Us</h3>
                  <p className="text-black dark:text-white font-medium mb-1">123 lorem ipsum Street</p>
                  <p className="text-gray-600 dark:text-gray-500 text-sm">lorem2, ipsum3, 10001</p>
                </div>
              </div>
              ...
              <div className="p-6 hover:bg-gray-100 dark:hover:bg-[#111c33] transition-colors duration-200">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-400 uppercase tracking-wider mb-2">Hours</h3>
                  <p className="text-black dark:text-white font-medium mb-1">Mon - Fri: 9AM - 6PM</p>
                  <p className="text-gray-600 dark:text-gray-500 text-sm">Sat: 10AM - 4PM</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-20">
            <div className="max-w-6xl mx-auto bg-gray-100 dark:bg-[#111c33] border border-gray-200 dark:border-[#1f2a44] rounded-lg overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
                ...
                <div className="lg:col-span-2 p-8">
                  <h3 className="text-xl font-semibold text-black dark:text-white mb-6">Submit a Request</h3>
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
                      <div className="form-field">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-[#1f2a44] rounded-lg text-black dark:text-white placeholder-gray-500
                      ...
                      <button
                        ...
                        focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-[#111c33]"
                      >
